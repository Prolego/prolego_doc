...
A otimização restrita é aquela que apresenta algum tipo de restrição no processo, já a não restrita permite que o processo seja executado sem nenhum tipo de variável restritiva \cite{lobato2008otimizaccao}.
...
O problema da mochila consiste em: dado um conjunto de itens, cada um com uma massa e um valor associado, determinar quais itens devem ser incluídos no conjunto de modo que a massa total seja menor ou igual à capacidade máxima da mochila e o valor do conjunto seja o maior possível \cite{prakasam2015metaheuristic}. 
